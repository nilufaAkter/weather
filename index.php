<?php
   ...
   if (isset($_POST['city'])){
        ...
        $locationUrl = "http://api.openweathermap.org/geo/1.0/direct?q={$cityname}&limit=1&appid=f44fa205495971dfbc4b01ef04b31f4e";

        $locations = json_decode(file_get_contents($locationUrl));
        $latitude = $locations[0]->lat;
        $long = $locations[0]->lon;
        
        $url = "https://api.openweathermap.org/data/2.5/forecast?lat={$latitude}&lon={$long}&appid=f44fa205495971dfbc4b01ef04b31f4e";
        $url2 ="https://api.openweathermap.org/data/2.5/weather?lat={$latitude}&lon={$long}&units=metric&appid=f44fa205495971dfbc4b01ef04b31f4e";
        ...
        <div class="container center mt-3 " style="background-color: rgba(0,0,0,.5);">
            <div class="row ">
                <div class="col-md-6 p-3" style="background-color:rgba(0, 0, 0, 0.30)">
                    ...
                    <form class=" mb-3 p-5" method="POST" action="index.php">
                  ...
                  <div class=" d-flex justify-content-center">
                        ...
                        <div class="card m-3 " style="width: 15rem;">
                            ...
                            <div class="card-body text-center" >
                                ...
                                <h5 class="card-title"><?php echo date('F j, Y', $clima->list[0]->dt) ?></h5>

                                <p class="card-text">
                                        
                                    <p style="font-size: 35px; color:#DEB887">

                                        <b><?php echo round( $clima->list[0]->main->temp)."&deg;C" ?> </b>
                                        <br>
                                        <span style="color:black;font-size:13px;text-transform: capitalize;">
                                            <?php echo $clima->list[0]->weather[0]->description ?>
                                            <img src="http://openweathermap.org/img/wn/<?php echo $clima->list[0]->weather[0]->icon?>.png" ?>
                                        </span>
                        ...
                        <div class="card m-3" style="width: 15rem;">
                            <div class="card-body text-center">
                                ...
                                <h5 class="card-title"><?php echo date('F j, Y', $clima->list[2]->dt) ?></h5>
                                <p class="card-text">
                                    <p style="font-size: 35px; color:#DEB887">

                                    <b><?php echo round( $clima->list[2]->main->temp)."&deg;C" ?> </b>
                                    <br>
                                    <span style="color:black;font-size:13px;text-transform: capitalize;">
                                        <?php echo $clima->list[2]->weather[0]->description ?>
                                        <img src="http://openweathermap.org/img/wn/<?php echo $clima->list[2]->weather[0]->icon?>.png" ?>
                                    </span>
                        ...
                        <div class="card m-3" style="width: 15rem;">
                            <div class="card-body text-center">
                                ...
                                <h5 class="card-title"><?php echo date('F j, Y', $clima->list[10]->dt) ?></h5>
                                <p class="card-text">
                                <p style="font-size: 35px; color:#DEB887">

                                        <b><?php echo round( $clima->list[10]->main->temp)."&deg;C" ?> </b>
                                        <br>
                                        <span style="color:black;font-size:13px;text-transform: capitalize;">
                                            <?php echo $clima->list[10]->weather[0]->description ?>
                                            <img src="http://openweathermap.org/img/wn/<?php echo $clima->list[10]->weather[0]->icon?>.png" ?>
                                        </span>
                ...
                <div class=" d-flex justify-content-center">
                    <div class="card m-3 " style="width: 15rem;">
                        ...
                        <div class="card-body text-center">
                            ...
                            <h5 class="card-title"><?php echo date('F j, Y', $clima->list[20]->dt) ?></h5>
                            <p class="card-text">
                                <p style="font-size: 35px; color:#DEB887">

                                <b><?php echo round( $clima->list[20]->main->temp)."&deg;C" ?> </b>
                                <br>
                                <span style="color:black;font-size:13px;text-transform: capitalize;">
                                    <?php echo $clima->list[20]->weather[0]->description ?>
                                    <img src="http://openweathermap.org/img/wn/<?php echo $clima->list[20]->weather[0]->icon?>.png" ?>
                                </span>
                    ...
                    <div class="card m-3" style="width: 15rem;">
                        <div class="card-body text-center">
                            ...
                            <h5 class="card-title"><?php echo date('F j, Y', $clima->list[30]->dt) ?></h5>
                            <p class="card-text">
                                <p style="font-size: 35px; color:#DEB887">

                                    <b><?php echo round( $clima->list[30]->main->temp)."&deg;C" ?> </b>
                                    <br>
                                    <span style="color:black;font-size:13px;text-transform: capitalize;">
                                        <?php echo $clima->list[30]->weather[0]->description ?>
                                        <img src="http://openweathermap.org/img/wn/<?php echo $clima->list[30]->weather[0]->icon?>.png" ?>
                                    </span>
                    ...
                    <div class="card m-3" style="width: 15rem;">
                        <div class="card-body text-center">
                            ...
                            <h5 class="card-title"><?php echo date('F j, Y', $clima->list[35]->dt) ?></h5>
                            <p class="card-text">
                                <p style="font-size: 35px; color:#DEB887">

                                    <b><?php echo round( $clima->list[35]->main->temp)."&deg;C" ?> </b>
                                    <br>
                                    <span style="color:black;font-size:13px;text-transform: capitalize;">
                                        <?php echo $clima->list[35]->weather[0]->description ?>
                                        <img src="http://openweathermap.org/img/wn/<?php echo $clima->list[35]->weather[0]->icon?>.png" ?>
                                    </span>
